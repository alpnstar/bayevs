    ...
    return (
        <About title={'Контакты'}>
            <div className="contacts">
                ...
                <h3 className="contacts__email">E-mail: <a href="mailto:bayevs@mail.ru">bayevs@mail.ru</a></h3>
                ...
                <h3 className="contacts__email">E-mail: <a href="mailto:bayevs@bk.ru">bayevs@bk.ru</a></h3>
