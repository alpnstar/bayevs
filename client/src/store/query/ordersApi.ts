...
import {ApiResponse, ApiResponseExtended, ItemsApiParams, OrderItem, OrderSingleResponse} from "../../types/types";
...
export const ordersApi = createApi({
    ...
    endpoints: (builder) => ({
        getOrderById: builder.query<OrderSingleResponse, string>({
            query: (id) => `/orders/${id}/items`,  // используем id в качестве строки
        }),
